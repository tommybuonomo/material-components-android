...
$HOME/android-sdk/tools/bin/sdkmanager "system-images;android-$EMULATOR_API;google_apis;$ABI"
$HOME/android-sdk/tools/bin/avdmanager list targets
echo no | $HOME/android-sdk/tools/bin/avdmanager create avd --force -n test -k "system-images;android-$EMULATOR_API;google_apis;$ABI"
